...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update users set f_name='$_POST[fname]', l_name='$_POST[lname]',email='$_POST[email]',phone='$_POST[phone]',password='".$_POST[password]."',con_password='".$_POST[con-password]."' where email='$_GET[user_upd]' ";
	mysqli_query($db, $mql);
					 ...
					 <div class="container-fluid">
                  	<?php  
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
							  <?php $ssql ="select * from users where email='$_GET[user_upd]'";
										 ...
										 <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="con-password" class="form-control form-control-danger"   value="<?php  echo $newrow['con_password'];  ?>" placeholder="con-password">
                                                    </div>
                                                </div>

...
if(isset($_POST['submit'] ))
{
	...
	$check_email = mysqli_query($db, "SELECT email FROM signup where email = '".$_POST['email']."' ");
	...
	$mql = "INSERT INTO users(f_name,l_name,email,phone,password,con_password) VALUES('".$_POST['fname']."','".$_POST['lname']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['password']."','".$_POST['con-password']."')";
